...
import ann.util.Data.NormalizationTypesENUM;
...
try{
    ...
    double[][] matrixOutputNorm = weatherDataInput.normalize(matrixOutput, NORMALIZATION_TYPE);
    ...
    double[][] matrixOutputJoined = new Data().joinArrays(listOfArraysToJoin);
    
    Chart c2 = new Chart();
    c2.plotXYData(matrixOutputJoined, "Real x Estimared - Training Fata", "Weather Data", "Temperature (Celsius)", Chart.ChartPlotTypeENUM.COMPARISON);
    ...
    Chart c3 = new Chart();
    c3.plotXYData(matrixOutputsJoinedTest, "Real x Estimated - Test Data", "Weather Data","Temoerature (Celius)", Chart.ChartPlotTypeENUM.COMPARISON);
