...
public class DiabetesDisease {
    ...
    public static void main(String[] args){
        ...
        Data diseaseDataInput = new Data("data", "diabetes_input_training.csv");
        ...
        try{
            ...
            double[][] matrixInputTestRNA = diseaseDataOutput.rawData2Matrix(diseaseDataInput);
            ...
            c3.plotBarChart(matrixOutputsJoinedTest, "Real x Estimated - Test Data", "Diabetes Data", " Diagnosis (0: NO / 1: YES)");
                ...
                //SENSITIVITY
                System.out.println("SENSITIVITY = " + classif.calculateSensitvity(confusionMatrix));
