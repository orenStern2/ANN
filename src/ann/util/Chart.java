...
public class Chart {
            ...
            for (int cols_i = 0 ; cols_i < cols; cols_i++){
                ...
                switch (chartPlotType){
                    ...
                    case COMPARISON:
                        ...
                        break;
                    default:
                        throw new IllegalArgumentException(chartPlotType + "does not Exist in ChartPlotENUM");
                }
    ...
    JFreeChart chart = ChartFactory.createLineChart(chartTitle, YAxisLabel, YAxisLabel, dataset,
    PlotOrientation.VERTICAL,
    true,
    true,
    false
